...
import { StyleSheet, Alert, AsyncStorage, TouchableOpacity } from 'react-native';
...
mostrarPagos=()=>{
  //fetch('http://192.168.0.108/pruebas/pagos_realizados.php',{
    fetch('http://www.zolumarket.com/pruebas/delivery_encurso.php',{
      method: 'POST',
      headers: {
      ...
      return(
        <View>
            {this.state.datosPagos.map((element, key)=>(
             ...
             <View>
                <ListItem icon onPress={() => navigation.navigate('Mapa',{dir:element.direccion} )}>
                  <Left>
